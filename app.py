...
(16, 30, "〃", "s2", "金"),
    ...
    for d in range(1, 32):
        ...
        weekday = weekday_map[this_date.weekday()]

        for h, m, name, col, condition in schedules:
            if condition == "全":
                matched = True
            elif isinstance(condition, list):
                matched = weekday in condition
            else:
                matched = condition == weekday
            ...
            if d in calendar_data and h in calendar_data[d]:
