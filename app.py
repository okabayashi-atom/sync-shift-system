...
def apply_fixed_service_schedule(calendar_data, target_year, target_month):
    ...
    schedules = [
        ...
        # ーーー サービス2 (s2) ーーー
        # --- 月 ---
        (9, 0, "脇坂sw", "s2", "月", "#ffff00"),
        (9, 30, "〃", "s2", "月", "#ffff00"),
        (10, 0, "貝森h", "s2", "月", "#ffff00"),
        (11, 30, "木村fh", "s2", "月", "#ffff00"),
        (12, 30, "貝森c", "s2", "月", "#ffff00"),
        (13, 0, "赤尾sw", "s2", "月", "#ffff00"),
        (13, 30, "〃", "s2", "月", "#ffff00"),
        (14, 0, "木村b", "s2", "月", "#ffff00"),
        (15, 0, "脇坂", "s2", "月", "#ffff00"),
        (15, 30, "〃", "s2", "月", "#ffff00"),
        (16, 0, "貝森sw", "s2", "月", "#ffff00"),
        (16, 30, "〃", "s2", "月", "#ffff00"),
        # --- 火 ---
        (14, 0, "山中sw", "s2", "火", "#ffff00"),
        (14, 30, "〃", "s2", "火", "#ffff00"),
        (16, 0, "上吉川sw", "s2", "火", "#ffff00"),
        (16, 30, "〃", "s2", "火", "#ffff00"),
        # --- 水 ---
        (14, 0, "棟方s", "s2", "水", "#ffff00"),
        (14, 30, "〃", "s2", "水", "#ffff00"),
        (16, 0, "斎藤sw", "s2", "水", "#ffff00"),
        (16, 30, "〃", "s2", "水", "#ffff00"),
        # --- 木 ---
        (9, 30, "越智h", "s2", "木", "#ffff00"),
        (10, 0, "貝森h", "s2", "木", "#ffff00"),
        (11, 30, "木村fh", "s2", "木", "#ffff00"),
        (12, 30, "貝森c", "s2", "木", "#ffff00"),
        (13, 0, "石田sw", "s2", "木", "#ffff00"),
        (13, 30, "〃", "s2", "木", "#ffff00"),
        (14, 0, "御前sw", "s2", "木", "#ffff00"),
        (14, 30, "〃", "s2", "木", "#ffff00"),
        # --- 金 ---
        (14, 0, "棟方s", "s2", "金", "#ffff00"),
        (14, 30, "〃", "s2", "金", "#ffff00"),
        (15, 0, "〃", "s2", "金", "#ffff00"),
        (16, 0, "菅原s", "s2", "金", "#ffff00"),
        (16, 30, "〃", "s2", "金", "#ffff00"),
        # --- 土 ---
        (16, 0, "斎藤sw", "s2", "土", "#ffff00"),
        (16, 30, "〃", "s2", "土", "#ffff00"),
        # --- 日 ---
        ...
        # ーーー サービス3 (s3) ーーー
        # --- 月 ---
        (16, 30, "石田w", "s3", "月", "#ffff00"), 
        (17, 0, "平野sw", "s3", "月", "#ffff00"),
        (17, 30, "〃", "s3", "月", "#ffc0cb"),
        (18, 0, "上吉川w", "s3", "月", "#ffc0cb"),
        # --- 火 ---
        (10, 0, "貝森h", "s3", "火", "#ffff00"),
        (10, 30, "八子sw", "s3", "火", "#ffff00"),
        (11, 0, "〃", "s3", "火", "#ffff00"),
        (11, 30, "木村fh", "s3", "火", "#ffff00"),
        (12, 0, "貝森c", "s3", "火", "#ffff00"),
        (14, 0, "照井b", "s3", "火", "#ffff00"),
        (14, 30, "〃", "s3", "火", "#ffff00"),
        (15, 0, "八子b", "s3", "火", "#ffff00"),
        (15, 30, "〃", "s3", "火", "#ffff00"),
        (16, 0, "樺澤sw", "s3", "火", "#ffff00"),
        (16, 30, "〃", "s3", "火", "#ffff00"),
        (17, 0, "樺澤h", "s3", "火", "#ffff00"),
        (17, 30, "平野w", "s3", "火", "#ffc0cb"),
        # --- 水 ---
        ...
        (16, 30, "〃", "s3", "木", "#ffff00"),
        (17, 30, "平野w", "s3", "木", "#ffc0cb"),
        (18, 0, "上吉川w", "s3", "木", "#ffc0cb"),
        # --- 金 ---
        (10, 0, "貝森h", "s3", "金", "#ffff00"),
        (10, 30, "八子sw", "s3", "金", "#ffff00"),
        (11, 0, "〃", "s3", "金", "#ffff00"),
        (11, 30, "木村fh", "s3", "金", "#ffff00"),
        (12, 0, "貝森c", "s3", "金", "#ffff00"),
        (14, 0, "山中sw", "s3", "金", "#ffff00"),
        (14, 30, "〃", "s3", "金", "#ffff00"),
        (15, 0, "八子b", "s3", "金", "#ffff00"),
        (15, 30, "〃", "s3", "金", "#ffff00"),
        (16, 0, "樺澤sw", "s3", "金", "#ffff00"),
        (16, 30, "〃", "s3", "金", "#ffff00"),
        (17, 0, "樺澤h", "s3", "金", "#ffff00"),
        (17, 30, "平野w", "s3", "金", "#ffc0cb"),
        (18, 0, "上吉川w", "s3", "金", "#ffc0cb"),
        # --- 土 ---
        (10, 0, "貝森h", "s3", "土", "#ffff00"),
        (10, 30, "上吉川b", "s3", "土", "#ffff00"),
        (11, 0, "〃", "s3", "土", "#ffff00"),
        (12, 0, "貝森c", "s3", "土", "#ffff00"),
        (13, 0, "照井sw", "s3", "土", "#ffff00"),
        (13, 30, "〃", "s3", "土", "#ffff00"),
        ...
        (11, 30, "木村fh", "s3", "日", "#ffff00"),
        (12, 0, "貝森c", "s3", "日", "#ffff00"),
        (14, 0, "木村sw", "s3", "日", "#ffff00"),
        (14, 30, "〃", "s3", "日", "#ffff00"),
        (17, 30, "平野sw", "s3", "日", "#ffc0cb"),
        (18, 0, "上吉川w", "s3", "日", "#ffc0cb"),
    ]
